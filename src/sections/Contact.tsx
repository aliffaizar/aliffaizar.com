...
export default function Contact() {
  ...
  return (
    <section id='contact' className='px-0 md:px-4 py-8 lg:px-8 w-full'>
      ...
      <div className='mt-8 flex flex-col-reverse lg:flex-row gap-4 lg:gap-8'>
        <form className='w-full bg-zinc-900 p-8' onSubmit={onSubmit}>
          ...
          <div className='relative float-right'>
            <div className='relative mt-4'>
              <div className='bg-gradient-to-r from-cyan-500 via-blue-500 to-indigo-500 w-44 h-9 md:w-52 md:h-10'></div>
              <button
                type='submit'
                className='w-44 h-9 md:w-52 md:h-10 bg-white text-gray-900 font-mono text-xl flex items-center justify-center absolute right-2 bottom-2 hover:right-0 hover:bottom-0'
              >
                Send
              </button>
            </div>
        ...
        <div className='w-full lg:w-1/3'>
          ...
          <div className='flex flex-row lg:flex-col items-center justify-center gap-8 lg:items-start lg:gap-4'>
            <div>
